...
local hqvo = "opengl-hq:interpolation:swapinterval=1:scaler-resizes-only:scale=spline36:scale-radius=4:scale-antiring=1.0:cscale=spline36:cscale-radius=3:dscale=spline36:dscale-radius=3:tscale=oversample:dither-depth=8:fbo-format=rgb32f:linear-scaling:icc-profile-auto"
