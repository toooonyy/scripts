...
local hqvo = "opengl:scale=spline36:dscale=mitchell:cscale=spline36:temporal-dither:dither-depth=8:correct-downscaling:linear-scaling:icc-profile-auto:blend-subtitles=video:pbo:3dlut-size=256x256x256"
