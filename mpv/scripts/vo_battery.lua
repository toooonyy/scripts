...
local hqvo = "opengl:scaler-resizes-only:scale=spline36:dscale=mitchell:cscale=spline36:dither-depth=8:fbo-format=rgb32f:correct-downscaling:linear-scaling:pbo:icc-profile-auto"
