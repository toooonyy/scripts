...
local hqvo = "opengl:scale=spline36:dscale=mitchell:cscale=bicubic:temporal-dither:dither-depth=8:correct-downscaling:linear-scaling:icc-profile-auto:blend-subtitles=video:pbo"
